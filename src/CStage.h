...
public:
		...
		vec(0.1f)
	{
		...
		doc_name[STAGE1] = "【海底の住人】";
		doc_name[STAGE2] = "【深海の漂う影】";
		doc_name[STAGE3] = "【奈落の底のモノ】";
		doc_name[STAGE4] = "【深淵の恐怖】";

		board.addRequest({ 1,"海底の住人", "海底に潜む影を討伐せよ" , 1, CLoad::Instance().getEfaceGrh(GHOUL)});
		board.addRequest({ 2,"深海の漂う影", "深海の怨霊を討伐せよ" , 5, CLoad::Instance().getEfaceGrh(ZPTHOMMOG) });
